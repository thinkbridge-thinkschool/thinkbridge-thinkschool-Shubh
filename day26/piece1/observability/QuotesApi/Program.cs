...
var activitySource = QuotesTelemetry.ActivitySource;
...
// Day 22 — Polly resilience pipeline (bulkhead, timeout, retry, circuit breaker) around
// the demo outbound HTTP dependency. See Extensions/ResilienceExtensions.cs.
builder.Services.AddDemoDependencyResilience(builder.Configuration);
builder.Services.AddScoped<DemoDependencyClient>();
